...
link_namelist_wps >> [run_geogrid, download_icbc] >> run_ungrib >> run_metgrid >> update_namelist_input >> link_namelist_input >> run_real >> run_wrf
